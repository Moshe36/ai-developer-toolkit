...
- Check `documentation/PROJECT_KNOWLEDGE.md` for architecture overview and integration points
- Reference `documentation/TROUBLESHOOTING.md` for known issues and gotchas
