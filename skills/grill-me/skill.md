---
name: grill-me
description: Interview the user relentlessly about a plan or design until reaching shared understanding, resolving each branch of the decision tree. Use when user wants to stress-test a plan, get grilled on their design, or says "grill me".
---
...
Use the **Question tool** for every question you ask. Never pose questions as plain text — always use the multiple-choice popup so the user can quickly select an answer or type a custom one.
...
For a **feature or design**, cover:
- Core purpose and success criteria — what does done look like?
- Who uses it and how?
- What are the edge cases and failure modes?
- What are the constraints (performance, security, backward compat)?
- What's explicitly out of scope?
- How does it interact with existing systems?

For a **plan or approach**, cover:
...
- What's the order of operations and why?

## Tone

Be direct. Be relentless. Don't accept vague answers — probe until the answer is specific and actionable. The goal is to surface assumptions and unresolved decisions *before* implementation, not during.
